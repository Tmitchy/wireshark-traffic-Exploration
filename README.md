...
|-------------|-------------|
| `pcap-files/` | 📂 Directory containing`.pcap` files,[forest park school.pcap](https://github.com/Tmitchy/wireshark-traffic-Exploration/blob/main/Forest%20Park%20School.pcap), [holiday_agency_evidence.pcap](|
